...
//caso objeto 2 Let miobjeto2 = {}; //Esta opción es breve y recomendada

//caso String 1
let miCaddenal = new String('Hola'); //Sintaxis formal
//caso String 2
...
//caso boolean 1
let miBoolean1 = new Boolean (false); //Formal //caso boolean 2
...
//Uso de prototype
Persona3.prototype.telefono ='84846497843544';
console.log(padre); 
console.log(madre.telefono); 
madre.telefono = '5484846497843544';
console.log(madre.telefono);
...
console.log(persona4.nombreCompleto2('Lic.','54548484651515')); 
console.log(persona4.nombreCompleto2.call(persona5, 'Ing.', '5492618585856'));

//metodo apply
let arreglo=['Ing','5465464846464']
